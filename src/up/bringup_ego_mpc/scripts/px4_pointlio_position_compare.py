...
class Px4PointlioPositionCompare(Node):
    ...
    def maybe_init_reference(self) -> bool:
        ...
        if self.ref_visual_odom is None:
            self.ref_visual_odom = tuple(float(value) for value in self.latest_visual_odom.position)
        return True
    ...
    def timer_callback(self) -> None:
        ...
        self.get_logger().info(
            ...
            f"bridge=({visual_odom_rel[0]:+.2f}, {visual_odom_rel[1]:+.2f}, {visual_odom_rel[2]:+.2f}) m | "
        ...
        self.get_logger().info(
            ...
            f"bridge NED pos=({visual_odom_position[0]:+.2f}, {visual_odom_position[1]:+.2f}, {visual_odom_position[2]:+.2f}) "
