...
namespace ego_planner
{
  ...
  private:
    ...
    bool validate_goal_occupancy_;
    bool require_occupancy_for_goal_;
    ...
    // A deterministic value is required before the first trajectory is
    // generated. An uninitialised flag can otherwise skip the emergency
    // trajectory or execute it unexpectedly after a sensor timeout.
